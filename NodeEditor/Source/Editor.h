...
struct DeleteItemsAction final: EditorAction
{
	...
	virtual void EmptyClear() override final;
	...
	void setClear(bool t) { m_ClearScreen = t; }
	bool isClear() { return m_ClearScreen; }
...
struct EditorContext
{
	...
	bool GetClearCommand() { return m_ClearCommand; }
